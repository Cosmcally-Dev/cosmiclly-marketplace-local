...
const overviewLabel: Record<HoroscopePeriod, string> = {
...
const Horoscope = () => {
  ...
  const { data: horoscope, isLoading } = useHoroscope(selectedSign, timeFrame);
                ...
                <div className="bg-card rounded-2xl border border-border p-6 md:p-8">
                  <TabsContent value="overview" className="mt-0">
                    <div className="flex items-start gap-4">
                      ...
                      <div>
                        <h3 className="font-heading text-xl font-semibold mb-3">{overviewLabel[timeFrame]}</h3>
                        {isLoading && !horoscope ? (
                          <Skeleton className="h-20 w-full" />
                        ) : (
                          <p className="text-foreground/90 leading-relaxed text-lg">{horoscope?.content.daily}</p>
                        )}
                      </div>
                    </div>
                  </TabsContent>
                    ...
                    <div className="flex items-start gap-4">
                      ...
                      <div>
                        ...
                        {isLoading && !horoscope ? (
                          ...
                          <p className="text-foreground/90 leading-relaxed text-lg">{horoscope?.content.love}</p>
                        )}
                      </div>
                    </div>
                  </TabsContent>
                    ...
                    <div className="flex items-start gap-4">
                      ...
                      <div>
                        ...
                        {isLoading && !horoscope ? (
                          ...
                          <p className="text-foreground/90 leading-relaxed text-lg">{horoscope?.content.career}</p>
                        )}
                      </div>
                    </div>
                  </TabsContent>
                    ...
                    <div className="flex items-start gap-4">
                      ...
                      <div>
                        ...
                        {isLoading && !horoscope ? (
                          ...
                          <p className="text-foreground/90 leading-relaxed text-lg">{horoscope?.content.money}</p>
                        )}
                      </div>
                    </div>
                  </TabsContent>
                    ...
                    <div className="flex items-start gap-4">
                      ...
                      <div>
                        ...
                        {isLoading && !horoscope ? (
                          ...
                          <p className="text-foreground/90 leading-relaxed text-lg">{horoscope?.content.health}</p>
                        )}
                      </div>
                    </div>
                  </TabsContent>
                    ...
                    <div className="flex items-start gap-4">
                      ...
                      <div>
                        ...
                        {isLoading && !horoscope ? (
                          ...
                          <p className="text-muted-foreground mt-4">Lucky elements are only available for daily horoscopes.</p>
                        )}
                      </div>
                    </div>
                  </TabsContent>
