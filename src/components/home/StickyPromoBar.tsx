...
export const StickyPromoBar = () => {
  ...
  return (
    <div className="bg-gradient-to-r from-secondary to-primary text-white relative">
      <div className="container mx-auto px-4 py-2.5">
        <div className="flex items-center justify-center gap-2 sm:gap-3 text-sm">
          ...
          <span className="font-medium text-xs sm:text-sm font-sans text-white">
            Get <span className="text-accent font-bold">3 Free Minutes</span> + <span className="text-accent font-bold">70% Off</span>
          </span>
          <Button
            variant="ghost"
            size="sm"
            className="h-9 sm:h-8 px-4 sm:px-3 text-xs font-bold bg-background text-primary hover:bg-background/90 shadow-lg transition-all min-w-[140px] font-sans"
          >
